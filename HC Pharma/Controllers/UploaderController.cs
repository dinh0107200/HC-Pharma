...
namespace HC_Pharma.Controllers
{
    ...
    public class UploaderController : Controller
    {
        ...
        [HttpPost]
        public ActionResult DeleteFile(string name, string folder = "albums")
        {
        ...
        [HttpPost]
        public JsonResult Upload(string folder = "albums")
        {
        ...
        private string SaveFileToDisk(HttpPostedFileBase fileData, string folderPath)
        {
                ...
                HtmlHelpers.CheckFileExt(Path.GetExtension(fileData.FileName), "jpg|png|gif|jpeg"))
            {
                ...
                Resize(fileData, 1500, 1200, Path.Combine(folder, fileName));
        ...
        private static FileInfo GetFileInfo(string name, string folder = "albums")
        {
        ...
        public static void Resize(HttpPostedFileBase originalImage, int maxWidth, int maxHeight, string path, string font = null, int fontsize = 0)
        {
            ...
            var myEncoderParameter = new EncoderParameter(myEncoder, 99L);
